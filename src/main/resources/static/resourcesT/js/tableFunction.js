...
const fillDataIntoInnerTable = (tableId, dataList, propertyList, editInnerFormFunction, deleteInnerFormFunction,
    ...
    dataList.forEach((item, index) => {
        ...
        btnEdit.onclick = () => {
            console.log('edit', item.id, index);
            editInnerFormFunction(item, index)
        ...
        btnDelete.onclick = (index) => {
            // console.log('delete',item.id);
            // deleteEmp(index);
            deleteInnerFormFunction(item, index);
        }
